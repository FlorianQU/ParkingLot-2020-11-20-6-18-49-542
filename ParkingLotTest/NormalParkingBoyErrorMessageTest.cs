...
{
    public class NormalParkingBoyErrorMessageTest
    {
        [Fact]
        public void Normal_ParkingBoy_Should_Add_Error_Message_Given_Wrong_Ticket()
        {
            //given
        ...
        [Fact]
        public void Normal_ParkingBoy_Should_Add_Error_Message_Given_No_Ticket()
        {
            //given
            var parkingLot = new ParkingLot.ParkingLot("parkingLot_1", 3);
            var parkingBoy = new NormalParkingBoy("parkingBoy_1", parkingLot);
