...
{
    public class SuperCleverParkingBoyErrorMessageTest
    {
        [Fact]
        public void Super_ParkingBoy_Should_Add_Error_Message_Given_Wrong_Ticket()
        {
            //given
        ...
        [Fact]
        public void Super_ParkingBoy_Should_Add_Error_Message_Given_Parked_Ticket()
        {
            //given
            var car = new Car("car_1");
            var newCustomer = new Customer("customer_1", car);
        ...
        [Fact]
        public void Super_ParkingBoy_Should_Add_Error_Message_Given_No_Ticket()
        {
            //given
            var parkingLot = new ParkingLot.ParkingLot("parkingLot_1", 3);
            var parkingBoy = new SuperCleverParkingBoy("parkingBoy_1", parkingLot);
        ...
        [Fact]
        public void Super_ParkingBoy_Should_Add_Error_Message_Given_Outof_Capacity()
        {
            //given
